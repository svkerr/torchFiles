-- same as simple-recurrent-network.lua except changed local variables
-- to global, in order to test and poke
...
while iteration < 500 do  -- limit number of iterations
   ...
   rnn:forget() -- forget all past time-steps, resets step counter
